                  ...
                  filteredTransactions.map((tx) => {
                    ...
                    return (
                      <TableRow key={tx.id}>
                        ...
                        <TableCell>
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild><Button variant="outline" size="icon" className="h-8 w-8 border-transparent hover:bg-accent"><MoreVertical className="h-4 w-4" /></Button></DropdownMenuTrigger>
